...
| README.md       | Root      | This is the main project readme file                                                                                                                                 |
| LICENSE         | Root      | Standard MIT license details                                                                                                                                         |
| .python-version | Root      | Our python version                                                                                                                                                   |
| data            | Root      | Some data `employees.json` and `people.json` for testing PySpark                                                                                                     |
| docs            | Root      | Any related documentation that might be of interest                                                                                                                  |
| test            | Root      | Testing frameworks to ensure our deployment is working correctly                                                                                                     |
